 ...
 */
var comment = "\"FirebasePluginExtras\"";
...
module.exports = {
     ...
     * script during the build process. The script executes Extras run command line
     * tool with the API and Secret keys.
     */
    addShellScriptBuildPhase: function (context, xcodeProjectPath) {
        ...
        var script = '"' + '' + '"';; // nothing to execute for now
